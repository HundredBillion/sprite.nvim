...
local lines = {
  ...
  "local c = s.current()",
  "vim.fn.writefile({vim.json.encode({marker=vim.g.sprite_session,pid=vim.fn.getpid(),surface=c and c.return_target,presentation=c and c.presentation,uis=#vim.api.nvim_list_uis()})},"
